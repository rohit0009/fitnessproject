									...
									echo '<div class="panel-body">
											<form class="form-horizontal" method="POST" action="'.htmlspecialchars($_SERVER["PHP_SELF"]).'">
												...
												<fieldset>
													...
													$course = $dtb->processQuery("select * from course where course_name = 'Table Tennis'");
													...
													echo '<div class="form-group">
														...
														<div class="col-lg-4">
															<select class="form-control" id="duration" name="duration">
																...
																<option value="3^&^'.$row['quarterly_d'].'^&^'.$row['monthly'].'">3 Month</option>
																<option value="6^&^'.$row['sixmonth_d'].'^&^'.$row['monthly'].'">6 Month</option>
