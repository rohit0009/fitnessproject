...
<body>
	...
	<?php
		$result = $dtb->processQuery("select course_id from course where course_name ='Zumba'");
		...
		echo'<div class="container">
				<div class="row">
					<div class="col-lg-3 page-header" style="border-bottom: 1px grey solid;">
						<div><h4>Zumba Enrollment</h4></div>
					</div>
							...
							<div class="col-lg-8">
									    ...
									    <div class="form-group">
									      <label for="select" class="col-lg-2 control-label">Select Batch</label>
											...
											echo '</select>
													...
													$course = $dtb->processQuery("select * from course where course_name = 'Zumba'");
								...
								<div class="col-lg-4 col-md-10 ">
									...
									<table class="table table-striped">
										<caption class="text-center">Seat Details for Zumba</caption>
										<thead>
											<tr>
